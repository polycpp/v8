...
| Suite | Result | Notes |
|-------|--------|-------|
| v8_unittests (C++) | **5764/5772 (99.9%)** | 8 failures: conservative stack visitor (4), LogAll, ConsoleTimeEvents, WeakMaps/Sets |
| mjsunit (JavaScript) | **7442/7502 (99.2%)** | 60 failures, 156 skipped (debug-only flags) |
