...
if(WIN32)
  target_link_libraries(v8_libbase PUBLIC dbghelp.lib winmm.lib ws2_32.lib)
  if(V8_ENABLE_ETW)
    target_link_libraries(v8_libbase PUBLIC advapi32.lib)
  endif()
else()
  target_link_libraries(v8_libbase PUBLIC pthread dl)
endif()
...
if(WIN32)
  ...
  # On Linux, push_registers_asm.cc is compiled as regular C++
...
if(WIN32)
  ...
  set(_d8_libs
    ...
    v8_zlib v8_zlib_google icu_interface
  )
  if(TARGET v8_simdutf)
    list(APPEND _d8_libs v8_simdutf)
  endif()
  if(TARGET v8_highway)
    list(APPEND _d8_libs v8_highway)
  endif()
  target_link_libraries(d8 PRIVATE -Wl,--start-group ${_d8_libs} -Wl,--end-group)
  target_link_libraries(d8 PRIVATE pthread dl)
endif()
