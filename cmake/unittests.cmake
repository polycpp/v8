...
# Exclude tests with MSVC-specific issues pending fixes
...
list(FILTER V8_UNITTEST_CC_FILES EXCLUDE REGEX "inner-pointer-resolution-unittest")  # needs LookupChunkContainingAddress (not in 12.4)
list(FILTER V8_UNITTEST_CC_FILES EXCLUDE REGEX "tracing-unittest")                  # needs Chromium trace event macros
list(FILTER V8_UNITTEST_CC_FILES EXCLUDE REGEX "conservative-stack-visitor-unittest")  # API differs in 12.4
list(FILTER V8_UNITTEST_CC_FILES EXCLUDE REGEX "hashcode-unittest")                    # needs halfsiphash (not in 12.4)
list(FILTER V8_UNITTEST_CC_FILES EXCLUDE REGEX "inobject-slack-tracking-unittest")    # undefined template functions in 11.3
list(FILTER V8_UNITTEST_CC_FILES EXCLUDE REGEX "trap-handler-simulator-unittest")    # simulator not built
list(FILTER V8_UNITTEST_CC_FILES EXCLUDE REGEX "object-start-bitmap-unittest")      # 32-bit cast issue on MSVC
...
list(APPEND V8_UNITTEST_HELPERS
  ...
  "${V8_ROOT}/test/common/wasm/wasm-interpreter.cc"
)
# value-helper.cc exists in 11.3+ but not in 10.2
if(EXISTS "${V8_ROOT}/test/common/value-helper.cc")
  list(APPEND V8_UNITTEST_HELPERS "${V8_ROOT}/test/common/value-helper.cc")
endif()
